...
public class EventHandler{
    ...
    public void checkEvent()
    {
        ...
        if(canTouchEvent == true)
        {
            ...
            else if(hit(0,10,39, "any") == true) {teleport(1,12,13,gp.indoor);} //originally to the merchant's house, from the bedroom to the livingroom
            else if(hit(1,12,13, "any") == true) {teleport(0,10,39,gp.outside);} //from livingroom back to bedroom
            ...
            else if(hit(2,8,7, "any") == true) {teleport(3,32,41,gp.dungeon);} //to hall fighting the skeleton lord, original col:26 and row:41
            else if(hit(3,26,41, "any") == true) {teleport(2,8,7,gp.dungeon);} //return back from the hall to the stairs
